...
public class BulletBaseService
{
    ...
    {
        // ... (Keep Base, Notes, Task, Meeting, Habit, Media, Holiday, Birthday, Anniversary tables) ...
        // ... (Paste previous code here if needed, I will just append the new one for brevity) ...
        ...
        // 2-9. (Notes, Tasks, Meetings, Habits, Media, Holidays, Birthdays, Anniversaries)
        ...
        // 10. NEW: Vacation Details
        await _db.Database.ExecuteSqlRawAsync(@"
            CREATE TABLE IF NOT EXISTS ""BulletVacationDetails"" (
                ""BulletItemId"" INTEGER NOT NULL PRIMARY KEY,
                ""VacationGroupId"" TEXT NOT NULL DEFAULT '',
                CONSTRAINT ""FK_BulletVacationDetails_BulletItems"" FOREIGN KEY (""BulletItemId"") REFERENCES ""BulletItems""(""Id"") ON DELETE CASCADE
            );
        ");
    }

    // ... (Keep DeleteItem, UpdateItemOrders, ClearDataByType, SaveImageAsync) ...
